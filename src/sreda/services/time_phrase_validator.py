...
# 5-11 утро / 12-16 день / 17-22 вечер / 23,0-4 ночь.
...
# вечер уже с 17 — обрабатываем 17:00 как "вечер" (audit-fix 2026-07-18:
# комментарий обещал это решение, код относил 17:00 к «день»).
