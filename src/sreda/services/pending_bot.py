...
_MEMORY = PendingReply(
    text=(
        "🧠 Память\n\n"
        "Главная фича: я не забываю. Запоминаю всё что важно, чтобы "
        "ты не держал в голове.\n\n"
        "📅 Расписание и напоминания — «во вторник к 16 Машу к "
        "стоматологу», «каждое утро в 8:30 кормить кота». "
        "На напоминаниях кнопки «Сделал ✅» / «Отложить ⏰».\n\n"
        ...
        "Сама ничего не выпытываю — только то, что говоришь сам. "
