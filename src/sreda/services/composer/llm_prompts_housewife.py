...
TENDER_CARE_COMPOSER_OVERLAY = (
    ...
    # (Codex R1 оба) — вместо этого запрет рефрена.
    "\n\nТон: нежная забота — мягче и теплее обычного. Формулируй "
    "бережно и поддерживающе; в конце уместна одна короткая тёплая "
    "фраза участия — избегай шаблонной одинаковой концовки, не "
    "превращай одну и ту же фразу в постоянный рефрен. Без сюсюканья "
