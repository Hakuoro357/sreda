...
# #262b create_memory_category: Output-модели и парсера НЕТ НАМЕРЕННО —
# инструмент ReAct-only (families.REACT_ONLY_TOOLS, канон #210). Долг Среза 1
# #270 закрыт в #213 Срезе A (обвязка мёртвого plan-execute пути не строится).
