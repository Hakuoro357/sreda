# Архив tomorrow-plan.md

> Старые записи из `docs/tomorrow-plan.md`. Политика ротации (Boris,
> 2026-06-12): в живом файле держим последние ~3 дня EOD-записей,
> остальное переносим сюда. Этот блок — до-EOD-журнальное содержимое
> (помечено `[archived]` ещё 2026-05-10 при переходе на GitHub Issues).
